...
#         Version strings do not start or end with dots, and they will not have two consecutive dots.
# 
...
class VersionComparator:
    def compare(self, version1:str, version2:str) -> int:
        ...
        for idx in range(max(len(ver1_list), len(ver2_list))):
            v1_part = int(ver1_list[idx]) if idx < len(ver1_list) else 0
            v2_part = int(ver2_list[idx]) if idx < len(ver2_list) else 0
...
if __name__ == "__main__":
    ...
    print(comp.compare( "0.1", "1.1"))
    print(comp.compare( "1.0.1", "1"))
    print(comp.compare( "7.5.2.4", "7.5.3"))
    print(comp.compare( "1.01", "1.001"))
    print(comp.compare("1.0", "1.0.0"))