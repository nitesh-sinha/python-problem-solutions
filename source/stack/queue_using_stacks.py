...
# Amortized time complexity of all functions: O(1)
# as each element is transferred from in_queue to out_queue
# only once
class MyQueue:
    def __init__(self):
        self.in_queue = []
    ...
    def pop(self) -> int:
        self.maybe_transfer_from_in_to_out()

        elem = self.out_queue.pop()
        self.length -= 1
        return elem
    ...
    def maybe_transfer_from_in_to_out(self):
